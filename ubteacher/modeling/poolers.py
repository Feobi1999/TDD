...
class ROIPooler(nn.Module):
    ...
    def __init__(
        ...
        # self.conv_cross1=nn.Conv2d(256, 256, kernel_size=3, stride=1,padding=1)
        # self.conv_cross2=nn.Conv2d(256, 256, kernel_size=3, stride=1,padding=1)
        #
    ...
    def forward(self, x: List[torch.Tensor], box_lists: List[Boxes], branch=""):
        """
        Args:
